...
public class NutritionistProfileActivity extends AppCompatActivity {
    ...
    @BindView(R.id.tv_nutri_profile_nome)
    TextView _tv_nutri_profile_nome;
    @BindView(R.id.tv_nutri_profile_cognome)
    TextView _tv_nutri_profile_cognome;
    @BindView(R.id.tv_nutri_profile_nascita)
    TextView _tv_nutri_profile_nascita;
    @BindView(R.id.tv_nutri_profile_email)
    TextView _tv_nutri_profile_email;

    @BindView(R.id.tv_nutri_profile_qualifica)
    TextView _tv_nutri_profile_qualifica;
    @BindView(R.id.tv_nutri_profile_codice_fiscale)
    TextView _tv_nutri_profile_codice_fiscale;

    @BindView(R.id.btn_nutri_profile_password)
    Button _btn_nutri_profile_password;
    @BindView(R.id.btn_nutri_profile_mail)
    Button _btn_nutri_profile_mail;
    @BindView(R.id.btn_nutri_profile_qualifica)
    Button _btn_nutri_profile_qualifica;
    @BindView(R.id.btn_nutri_profile_logout)
    Button _btn_nutri_profile_logout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _btn_nutri_profile_password.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ChangePassword(NutritionistProfileActivity.this, user_id);
            }
        });

        //Update qualification menegment
        _btn_nutri_profile_qualifica.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ChangeQualification(NutritionistProfileActivity.this, user_id);
            }
        });

        //Update email menegment
        _btn_nutri_profile_mail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ChangeEmail(NutritionistProfileActivity.this, user_id);
            }
        });
    ...
    private void GetDataSetView(int user_id) {
        //User Data
        NutritionistProfileActivity.GetUserDataConnection asyncTaskUser = (NutritionistProfileActivity.GetUserDataConnection) new NutritionistProfileActivity.GetUserDataConnection(new NutritionistProfileActivity.GetUserDataConnection.AsyncResponse() {
            @Override
            public void processFinish(String _name, String _cognome, String _email, String _nascita) {

                if (_name.equals("error")) {
                    Toast.makeText(NutritionistProfileActivity.this, "ERRORE CARICAMENTO DATI", Toast.LENGTH_SHORT).show();
                    Intent new_i = new Intent(NutritionistProfileActivity.this, LoginActivity.class);
                    startActivity(new_i);
                    finish();
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(NutritionistProfileActivity.this, "Ben tornato", Toast.LENGTH_SHORT).show();
                            _tv_nutri_profile_nome.setText(nome);
                            _tv_nutri_profile_cognome.setText(cognome);
                            _tv_nutri_profile_email.setText(email);
                            _tv_nutri_profile_nascita.setText(nascita.split("T")[0]);
                        }
                    });
                } else {
                    runOnUiThread(new Runnable() {
        ...
        //Trainer Data
        NutritionistProfileActivity.GetTrainerDataConnection asyncTaskTrainer = (NutritionistProfileActivity.GetTrainerDataConnection) new NutritionistProfileActivity.GetTrainerDataConnection(new NutritionistProfileActivity.GetTrainerDataConnection.AsyncResponse() {
            @Override
            public void processFinish(String _qualifica, String _codice_fiscale) {
                ...
                if (_qualifica.equals("error")) {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            _tv_nutri_profile_qualifica.setText(qualifica);
                            _tv_nutri_profile_codice_fiscale.setText(codice_fiscale);
                        }
                    });
                } else {
                    runOnUiThread(new Runnable() {
    ...
    private static class GetUserDataConnection extends AsyncTask<String, String, JsonObject> {
        ...
        public NutritionistProfileActivity.GetUserDataConnection.AsyncResponse delegate = null;

        public GetUserDataConnection(NutritionistProfileActivity.GetUserDataConnection.AsyncResponse delegate) {
    ...
    private static class GetTrainerDataConnection extends AsyncTask<String, String, JsonObject> {
        ...
        public NutritionistProfileActivity.GetTrainerDataConnection.AsyncResponse delegate = null;

        public GetTrainerDataConnection(NutritionistProfileActivity.GetTrainerDataConnection.AsyncResponse delegate) {
            this.delegate = delegate;
        }
        ...
        protected JsonObject doInBackground(String... params) {
            ...
            try {
                url = new URL("http://10.0.2.2:4000/nutritionist/get_all_data/" + params[0]);
                urlConnection = (HttpURLConnection) url.openConnection();
                urlConnection.setRequestMethod("GET");
    ...
    private void ChangeEmail(Activity a, int user_id) {
        NutritionistProfileActivity.CustomDialogEmailClass cdd = new NutritionistProfileActivity.CustomDialogEmailClass(a, user_id);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.dialog_confirm_user_type_yes:
                    if (checkEmails()) {
                        NutritionistProfileActivity.UpdateEmailConnection asyncTask = (NutritionistProfileActivity.UpdateEmailConnection) new NutritionistProfileActivity.UpdateEmailConnection(new NutritionistProfileActivity.UpdateEmailConnection.AsyncResponse() {
    ...
    public static class UpdateEmailConnection extends AsyncTask<String, String, Integer> {
        ...
        public NutritionistProfileActivity.UpdateEmailConnection.AsyncResponse delegate = null;

        public UpdateEmailConnection(NutritionistProfileActivity.UpdateEmailConnection.AsyncResponse delegate) {
            this.delegate = delegate;
        }
    ...
    private void ChangePassword(Activity a, int user_id) {
        NutritionistProfileActivity.CustomDialogPasswordClass cdd = new NutritionistProfileActivity.CustomDialogPasswordClass(a, user_id);
        cdd.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        cdd.show();
    }
    ...
    private class CustomDialogPasswordClass extends Dialog implements View.OnClickListener {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.dialog_confirm_user_type_yes:
                    if (checkInputs()) {
                        NutritionistProfileActivity.UpdatePasswordConnection asyncTask = (NutritionistProfileActivity.UpdatePasswordConnection) new NutritionistProfileActivity.UpdatePasswordConnection(new NutritionistProfileActivity.UpdatePasswordConnection.AsyncResponse() {
                            ...
                            public void processFinish(Integer output) {
                                if (output == 403) {
                                    runOnUiThread(new Runnable() {
                                        public void run() {
                                            Toast.makeText(NutritionistProfileActivity.this, "Vecchia password non corrisponde", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                } else if (output == 200) {
                                    runOnUiThread(new Runnable() {
    ...
    public static class UpdatePasswordConnection extends AsyncTask<String, String, Integer> {
        ...
        public NutritionistProfileActivity.UpdatePasswordConnection.AsyncResponse delegate = null;

        public UpdatePasswordConnection(NutritionistProfileActivity.UpdatePasswordConnection.AsyncResponse delegate) {
            this.delegate = delegate;
        }
    ...
    private void ChangeQualification(Activity a, int user_id) {
        NutritionistProfileActivity.CustomDialogQualificationClass cdd = new NutritionistProfileActivity.CustomDialogQualificationClass(a, user_id);
        cdd.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        cdd.show();
    }

    private class CustomDialogQualificationClass extends Dialog implements View.OnClickListener {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            qualifications.setText(_tv_nutri_profile_qualifica.getText().toString());
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.dialog_confirm_user_type_yes:
                    NutritionistProfileActivity.UpdateQualificationConnection asyncTask = (NutritionistProfileActivity.UpdateQualificationConnection) new NutritionistProfileActivity.UpdateQualificationConnection(new NutritionistProfileActivity.UpdateQualificationConnection.AsyncResponse() {
    ...
    public static class UpdateQualificationConnection extends AsyncTask<String, String, Integer> {
        ...
        public NutritionistProfileActivity.UpdateQualificationConnection.AsyncResponse delegate = null;

        public UpdateQualificationConnection(NutritionistProfileActivity.UpdateQualificationConnection.AsyncResponse delegate) {
            this.delegate = delegate;
        }
    ...
    private void DoLogout() {
        Utili.logout(NutritionistProfileActivity.this);
        Intent intent = new Intent(NutritionistProfileActivity.this, LoginActivity.class);
